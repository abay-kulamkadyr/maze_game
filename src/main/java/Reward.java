...
/**
 * Reward class with functionality that would help in creating and drawing rewards in the GameScreen
 * class.
 */
public class Reward {
  ...
  /**
   * returns true if the x and the y coordinate of the reward matches the x and y coordinate of the
