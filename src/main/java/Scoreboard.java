...
public class Scoreboard {
  ...
  /**
   * Creates a new Scoreboard with time and score as 0. Along with the startTime being the current
   * time.
   */
  public Scoreboard() {
    this.score = 0;
  ...
  /**
   * Resets the startTime to whenever the current time is. This is used so the displayed timer
   * resets when leaving the main menu.
   */
