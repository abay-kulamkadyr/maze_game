...
class TickThread extends Thread {
  ...
  /**
   * starts the Tick thread if the this thread is running then run a while loop until 1/32 of a
   * second has passed if 1/32 of a second has passed increase the tick count via calling
