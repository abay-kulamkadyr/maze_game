 ...
 * passed since the initial call of the class. The class modifies the tick count with every
 * Tick.instance() call.
 */
public class Tick {
  ...
  /** Private constructor, invoked only once Set tick and tickRunning to 0 */
  private Tick() {
    tick = 0;
    tickRunning = 0;
  }
